...
class ConditionalBottleNeck(nn.Module):
    ...
    def __init__(self, hidden_size, output_size):
        ...
        self.emb_transf = nn.Linear(hidden_size, hidden_size)
        self.hidden_modulation = FiLM(hidden_size, output_size)
        self.down_proj_layer = nn.Linear(output_size, output_size//3)
        self.up_proj_layer = nn.Linear(output_size//3, output_size)
